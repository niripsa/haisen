<?php
define('DS', DIRECTORY_SEPARATOR);header("Location: /m/");
...
if(is_file(SYS_PATH.'data/basic_config.php')){
	...
	//$GLOBALS['LANG']['email_open_config'] = unserialize($basic_config['email_open_config']);
...
if(in_array($_SERVER['HTTP_HOST'],array('127.0.0.1','127.0.0.1:8080','localhost','localhost:8080','192.168.1.189:8080'))){
    define('SITE_URL', 'http://'.$_SERVER['HTTP_HOST'].'/weixinfx09/');
}else{
