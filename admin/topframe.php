...
if(file_exists(SYS_PATH_ADMIN.'inc'.DS.'menulist.php'))
	include(SYS_PATH_ADMIN.'inc'.DS.'menulist.php');
...
<link rel="stylesheet" type="text/css" href="<?php echo ADMIN_URL.'css/css.css';?>"/>
<title>管理导航区域</title>
</head>
...
<p><span></span><a href="javascript::void(0)" class="name" target="mainFrame" ><?php echo $_SESSION['adminname'];?></a><a href="logout.php" class="out">退出</a></p>
</div>
