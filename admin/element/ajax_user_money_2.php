<table cellspacing="2" cellpadding="3" width="100%" style="line-height:25px;">
  ...
  <?php
   if(!empty($rt['usermoneylist'][2])){
   foreach($rt['usermoneylist'][2] as $row){
  ?>
  <tr>
  ...
  <?php echo $rt['usermoneypage'][2]['showmes'].$rt['usermoneypage'][2]['first'].'&nbsp;'.$rt['usermoneypage'][2]['prev'].'&nbsp;'.$rt['usermoneypage'][2]['next'].'&nbsp;'.$rt['usermoneypage'][2]['last'];?>
  </td>
  <td  align="right"><span style="position:absolute; right:0px; bottom:0px;"><img src="<?php echo ADMIN_URL;?>images/error_icon.png" alt="close" onclick="$('.user_money2').toggle();" style="cursor:pointer"/></span></td>
  </tr>
</table>