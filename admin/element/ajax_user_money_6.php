<table cellspacing="2" cellpadding="3" width="100%" style="line-height:25px;">
  ...
  <?php
   if(!empty($rt['usermoneylist'][6])){
   foreach($rt['usermoneylist'][6] as $row){
  ?>
  <tr>
  ...
  <?php echo $rt['usermoneypage'][6]['showmes'].$rt['usermoneypage'][6]['first'].'&nbsp;'.$rt['usermoneypage'][6]['prev'].'&nbsp;'.$rt['usermoneypage'][6]['next'].'&nbsp;'.$rt['usermoneypage'][6]['last'];?>
  </td>
  <td  align="right"><span style="position:absolute; right:0px; bottom:0px;"><img src="<?php echo ADMIN_URL;?>images/error_icon.png" alt="close" onclick="$('.user_money6').toggle();" style="cursor:pointer"/></span></td>
  </tr>
</table>