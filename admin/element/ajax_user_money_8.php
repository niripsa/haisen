<table cellspacing="2" cellpadding="3" width="100%" style="line-height:25px;">
  ...
  <?php
   if(!empty($rt['usermoneylist'][8])){
   foreach($rt['usermoneylist'][8] as $row){
  ?>
  <tr>
  ...
  <?php echo $rt['usermoneypage'][8]['showmes'].$rt['usermoneypage'][8]['first'].'&nbsp;'.$rt['usermoneypage'][8]['prev'].'&nbsp;'.$rt['usermoneypage'][8]['next'].'&nbsp;'.$rt['usermoneypage'][8]['last'];?>
  </td>
  <td  align="right"><span style="position:absolute; right:0px; bottom:0px;"><img src="<?php echo ADMIN_URL;?>images/error_icon.png" alt="close" onclick="$('.user_money8').toggle();" style="cursor:pointer"/></span></td>
  </tr>
</table>