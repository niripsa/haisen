<table cellspacing="2" cellpadding="3" width="100%" style="line-height:25px;">
  ...
  <?php
   if(!empty($rt['usermoneylist'][3])){
   foreach($rt['usermoneylist'][3] as $row){
  ?>
  <tr>
  ...
  <?php echo $rt['usermoneypage'][3]['showmes'].$rt['usermoneypage'][3]['first'].'&nbsp;'.$rt['usermoneypage'][3]['prev'].'&nbsp;'.$rt['usermoneypage'][3]['next'].'&nbsp;'.$rt['usermoneypage'][3]['last'];?>
  </td>
  <td  align="right"><span style="position:absolute; right:0px; bottom:0px;"><img src="<?php echo ADMIN_URL;?>images/error_icon.png" alt="close" onclick="$('.user_money3').toggle();" style="cursor:pointer"/></span></td>
  </tr>
</table>