...
<form id="form1" name="form1" method="post" action="">
     <table cellspacing="2" cellpadding="5" width="100%">
	 	 <tr>
			<th colspan="2" align="left" class="gototype"><span style="float:left"><?php echo $type=='edit' ? '修改' : '添加';?>商家</span><a href="user.php?type=shoplist" style="float:right; margin-left:10px;">返回商家列表</a></th>
		</tr>
		<tr>
