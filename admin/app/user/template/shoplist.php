...
<div class="contentbox">
	 ...
	 <tr>
		<th colspan="8" align="left" style="text-align:left">商家列表</th>
	</tr>
	...
	<br/><a onclick="ajax_bingweixin('goods.php?type=bingweixin&id=<?php echo $row['user_id'];?>')" href="javascript:;" style="padding:3px; color:#FF0000; cursor:pointer; background:#ededed; border-bottom:1px solid #ccc; border-right:1px solid #ccc">绑定微信</a>
	</td>
	</tr>
	<?php
	 } ?>
