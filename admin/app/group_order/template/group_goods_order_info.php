...
<table cellspacing="2" cellpadding="5" width="100%" class="order_basic">
    ...
    <tr>
        ...
        <table cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                ...
                <td width="35%"><?php echo !empty($rt['orderinfo']['shipping_time']) ? date('Y-m-d H:i:s',$rt['orderinfo']['shipping_time']) : '无'; ?></td>
            </tr>
            <tr>
    ...
    <tr>
        ...
        <table cellspacing="0" cellpadding="0" width="100%" class="order_basic">
            <tr>
                ...
                <td width="35%">
                <a href="user.php?type=userress&id=<?php echo $rt['orderinfo']['user_id'];?>" style="color:#FE0000" title="查看详情">
                <?php echo $rt['orderinfo']['consignee'];?></a>
                <em>[点击可进入收货人详情]</em>
                </td>                
    ...
    <tr>
        ...
        <table cellspacing="0" cellpadding="0" width="100%" >
            ...
            ?>
            <tr align="center">
                <td><a href="<?php echo SITE_URL; ?>m/group_product.php?id=<?php echo $row['goods_id'];?>" target="_blank"><?php echo $row['goods_name']; ?></a></td>
            ...
            <?php } ?>
            <tr align="center">
                <td colspan="7" align="right">总价:</td>
...
<?php $thisurl = ADMIN_URL.'group_goods_order.php'; ?>
