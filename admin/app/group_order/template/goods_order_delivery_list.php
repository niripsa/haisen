<?php
$thisurl = ADMIN_URL . 'group_goods_order.php'; 
if ( isset( $_GET['asc'] ) ) {
...
<div class="contentbox">
    ...
    <td>
    <a href="group_goods_order.php?type=order_info&id=<?php echo $row['order_id'];?>" title="编辑"><img src="<?php echo $this->img('icon_view.gif');?>" title="编辑"/></a>&nbsp;
  ...
  //批量删除
   ...
   $('.delorder').click(function(){
    ...
    function update_2012127( id, object,sid ) {
       ...
       $.post('<?php echo ADMIN_URL.'group_shopping.php'; ?>', { action:'ajax_shopping_op', oid:id, val:editval, sid:sid }, function( data ) {
             obj.html(editval);
             $(object).unbind('click');
