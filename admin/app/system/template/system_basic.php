<div class="contentbox">
	...
	<tr>
		<td class="label" width="15%">网站简称:</td>
		<td width="85%">
<input name="site_name" id="site_name"  type="text" style="width:315px;" value="<?php echo isset($rt['site_name']) ? $rt['site_name'] : '';?>">
	  ...
	  <tr>
		...
		<td><input name="site_url" id="site_url"  type="hidden" style="width:315px;" value="<?php echo isset($rt['site_url']) ? $rt['site_url'] : '';?>">
		 <iframe id="iframe_t" name="iframe_t" border="0" src="upload.php?action=<?php echo isset($rt['site_url'])&&!empty($rt['site_url'])? 'show' : '';?>&ty=site_url&tyy=qrcard&files=<?php echo isset($rt['site_url']) ? $rt['site_url'] : '';?>" scrolling="no" width="445" frameborder="0" height="25"></iframe>
		</td>
	  </tr>
	 <!-- <tr>
	  ...
	  <!--<tr>
       ...
       <tr>
		<td class="label">微信公众号非关键字回复语句:</td>
		<td><input name="respond" id="respond" value="<?php echo isset($rt['respond']) ? $rt['respond'] : '';?>" type="text" style="width:315px;"></td>
	  </tr>
	  <tr>
	  ...
	  <tr>
       ...
       <tr>
		<td class="label">注册协议:</td>
		<td><textarea name="reg_info" id="reg_info" style="width:95%;height:200px;display:none;"><?php echo isset($rt['reg_info']) ? $rt['reg_info'] : '';?></textarea>
		 <script>KE.show({id : 'reg_info',cssPath : '<?php echo ADMIN_URL.'/css/edit.css';?>' });</script>
		</td>
	  </tr>
	  <tr>
