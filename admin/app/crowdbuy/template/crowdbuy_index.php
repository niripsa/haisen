<div class="contentbox">
	 ...
	 <tr>
		<th colspan="8" align="left">众筹商品列表
            <span style="float:right">
                <a href="crowdbuy.php?type=info">添加众筹商品</a>
            </span>
        </th>
	</tr>
	<!-- <tr><td colspan="8" align="left" class="label">
    	...
    	众筹名称 <input name="keyword" size="15" type="text" value="<?php echo isset($_GET['keyword']) ? $_GET['keyword'] : '';?>">
	...
	<td><?php 
	$pr = ($row['start_time'] < time() && $row['end_time'] > time()) ? 1 : 0;
	echo $pr==0 ? "<font color=red>众筹结束</font>" : ($row['active']==0 ? "<font style='color:#6633FF'>活动无开启</font>" : "众筹进行中");
	?></td>
	<td>￥<?php echo $row['price'];?></td>
	<td>
	<a href="crowdbuy.php?type=info&id=<?php echo $row['group_id'];?>" title="编辑"><img src="<?php echo $this->img('icon_edit.gif');?>" title="编辑"/></a>&nbsp;
  ...
  //批量删除
   ...
   /* 商品搜索 */
    $('.cate_search').click(function(){
        ...
        location.href='<?php echo $thisurl;?>?type=goods_list&keyword='+keys;
    });
 </script>