<?php
$thisurl = ADMIN_URL.'crowd_goods_order.php'; 
if(isset($_GET['asc'])){
...
<div class="contentbox">
	...
	<td>
	<a href="crowd_goods_order.php?type=order_info&id=<?php echo $row['order_id'];?>" title="编辑"><img src="<?php echo $this->img('icon_view.gif');?>" title="编辑"/></a>&nbsp;
