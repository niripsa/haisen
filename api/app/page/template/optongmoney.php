...
<h2 class="con_title">资金操作记录</h2>
    ...
    <td width="51" bgcolor="#DFE0DC">消费</td>
  ...
  ?>
    ...
    <td class="cr2">账变</td>
    <td class="cr2"><?php echo $row['money']>0 ? $row['money'].'元' : '--';;?></td>
    <td class="cr2"><?php echo $row['money']<=0 ? str_replace('-','',$row['money']).'元' : '--';;?></td>
