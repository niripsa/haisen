...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
	<td width="340"><input name="sf_upfile" type="file"  class="border" id="sf_upfile" style="width:280px"/></td>
    <td>
...
<div id="LoadingBar" style="display:none" class="bj"><img src="<?php echo SITE_URL;?>theme/images/loadings.gif" alt="文件上传中，请稍后..." border="0" /></div>
<?php
}		
?>
</body>
