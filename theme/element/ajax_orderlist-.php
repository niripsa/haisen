			...
			<table width="100%"  cellpadding="0"  cellspacing="0" border="1" bordercolor="#e4e1e1">
				...
				<?php if($k==0){?>
				 <tr>
				  ...
				  <?php } ?>
				  <tr>
					<td colspan="5" style="padding-left:10px; text-align:left"><b>发放仓库地：</b><span class="loads"><img src="<?php echo SITE_URL;?>theme/images/loadings.gif" onload="return load_suppliers_address('<?php echo $row['suppliers_id'];?>',this)" onclick="return load_suppliers_address('<?php echo $row['suppliers_id'];?>',this)" title="无法看到地址请点击这里" align="absmiddle" style="cursor:pointer"/>无法看到地址请点击这里</span>&nbsp;</td>
				  ...
				  <tr>
					<td  width="260" style="text-align:left; padding-left:5px">
						<?php 
