...
<?php $this->element('user_menu');?>
    <div class="m_right">
		<h2 class="con_title">业务员管理</h2>
    	<div style="height:auto">
      		<ul class="salesmen_menu">
				<li class="active bindclick" lang="tab2">你的品牌销量</li>
				<li class="bindclick" lang="tab3">便利店销量</li>
				<li class="bindclick" lang="tab1">你的推广品牌</li>
			</ul>
 ...
 <form action="" method="get">
  <input type="hidden" name="act" value="salesmen_manage" />
			<table width="100%"  cellpadding="0"  cellspacing="0" border="1" bordercolor="#e4e1e1" class="tab" id="tab2" style="line-height:25px; text-align:center">
			  <tr>
			  	<td colspan="5" align="left">
					&nbsp;选择时间：<input type="text" id="EntTime1" name="date1" onclick="return showCalendar('EntTime1', 'y-mm-dd');" value="<?php echo isset($_GET['date1'])?$_GET['date1']:date('Y-m-d',mktime()-3600*24*7);?>"/>
			  ...
			  <tr>
				<td width="" class=" bg_grey">编号</td>
				<td class=" bg_grey" width="130">推广品牌</td>
				<td class=" bg_grey" width="375">便利店<br />地址</td>
				<td class=" bg_grey" width="88">总价</td>
				<td class=" bg_grey" width="90">总实价</td>
			  </tr>
			   <?php
			   if(!empty($rl)){
			   $zongprice = 0;
			  ...
			  <tr>
				...
				<td colspan="3">
					...
					<?php $al1=0;$a2=0; foreach($row as $rows){?>
						<tr>
							<td width="395"><?php echo $rows['user_name'];?><br/><span class="loads"><img src="<?php echo SITE_URL;?>theme/images/loadings.gif" onload="return load_shop_address('<?php echo $rows['shop_id'];?>',this)"/></span></td>
							<td width="90">￥<?php echo $rows['zmarket_price'];?></td>
					...
					<tr style="font-weight:bold">
						<td style="text-align:right">总销量&nbsp;</td><td>￥<?php echo $al1;?></td><td>￥<?php echo $a2;?></td>
					</tr>
					</table>
				</td>
			  </tr>
			<?php } } ?>
			 ...
			 <form action="" method="get">
 			 <input type="hidden" name="act" value="salesmen_manage" />
			<table width="100%"  cellpadding="0"  cellspacing="0" border="1" bordercolor="#e4e1e1" class="tab" id="tab3" style="display:none; line-height:25px; text-align:center">
			 <tr>
			  	<td colspan="5" align="left">
					&nbsp;选择时间：<input type="text" id="EntTime1" name="date1" onclick="return showCalendar('EntTime1', 'y-mm-dd');" value="<?php echo isset($_GET['date1'])?$_GET['date1']:date('Y-m-d',mktime()-3600*24*7);?>"/>
					<select name="t1" style="border:1px solid #ccc; margin-top:3px">
			  ...
			  <tr>
				<td width="107" class=" bg_grey">编号</td>
				<td class=" bg_grey" width="400">便利店<br />地址</td>
				<td class=" bg_grey" width="130">推广品牌</td>
				<td class=" bg_grey" width="88">总价</td>
				<td class=" bg_grey" width="90">总实价</td>
			  </tr>
			  ...
			  <tr>
				<td class="cr2"><?php echo ++$k;?></td>
				<td><?php echo $row[0]['user_name'];?><br/><span class="loads"><img src="<?php echo SITE_URL;?>theme/images/loadings.gif" onload="return load_shop_address('<?php echo $row[0]['shop_id'];?>',this)"/></span></td>
				<td colspan="3">
				<table width="100%"  cellpadding="0"  cellspacing="0" border="1" bordercolor="#e4e1e1">
				<?php $a3=0;$a4=0; foreach($row as $rows){?>
					<tr>
					<td width="122"><?php echo $rows['brand_name'];?></td>
					<td width="84">￥<?php echo $rows['zmarket_price'];?></td>
				...
				$zongprice4 += $rows['zmarket_price'];
					...
					<tr style="font-weight:bold">
						<td style="text-align:right">总销量&nbsp;</td><td>￥<?php echo $a3;?></td><td>￥<?php echo $a4;?></td>
					</tr>
				</table>
				</td>
			  </tr>
