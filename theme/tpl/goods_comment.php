...
<form id="form1" name="form1" method="post" action="">
     <table cellspacing="2" cellpadding="5" width="100%">
	  ...
	  <tr>
		...
		<tr>
			<td colspan="2">
			<P style="background:#F5F7F2; line-height:25px; margin-bottom:0px; border-bottom:1px solid #666"><strong>管理员</strong> <a href="mailto:<?php echo !empty($rt['rp_email']) ? $rt['rp_email'] : "";?>"><?php echo $rt['adname'];?></a> <strong>于</strong>  <?php echo !empty($rt['rp_addtime'])? date('H-m-d H:i:s',$rt['rp_addtime']) : '无知';?> <strong>回复</strong>&nbsp;&nbsp;<strong>最后更新</strong><font color="#FF0000">[<?php echo !empty($rt['up_time']) ? date('H-m-d H:i:s',$rt['up_time']) : '无更新';?>]</font>
			</P>
