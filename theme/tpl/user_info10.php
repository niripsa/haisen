...
<?php $this->element('user_menu');?>
    <div class="m_right" >
		<h2 class="con_title">供应商联系人资料</h2>
...
<table width="700" border="0" cellpadding="0" cellspacing="0" style="line-height:35px">
  ...
  <tr>
    <td align="right"><b class="cr2">*</b>供应商地址：</td>
    <td >
...
<select name="q_province" id="select_province" onchange="ger_ress_copy('2',this,'select_city')">
  ...
  <tr>
    <td align="right"><b class="cr2">*</b> 详细地址：</td>
    <td><input type="text" value="<?php echo isset($rt['userress']['q_address'])&&!empty($rt['userress']['q_address']) ? $rt['userress']['q_address'] : "";?>" name="q_address"  class="pw" style="width:400px;"/></td>
  </tr>
