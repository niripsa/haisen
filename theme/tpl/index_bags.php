<div class="bgmain">
	...
	<div class="bagbanner">
		...
		<?php $ad = $this->action('banner','banner','箱包主页顶部',5);?>
	...
	<?php $ad = $this->action('banner','banner','箱包主页专场',3);?>
	...
	<div class="fuzhuangtop">
		...
		<?php $ad = $this->action('banner','banner','箱包主页分类右边',4);?>
		<div class="ads">
		 <?php if(!empty($ad))foreach($ad as $row){?>
...
<?php $ad = $this->action('banner','banner','箱包主页分类下方',5);?>
	...
	<div class="bagitem">
		...
		<?php $this->element('bagsbanner',array('cid'=>$rt['cuxiaocat']['tcid']));?>
		</div>
	...
	<div class="bagitem">
		...
		<iframe src="<?php echo SITE_URL;?>bagsbanner2.php?cid=<?php echo $rt['newpincat']['tcid'];?>" scrolling="no" frameborder="0" width="300" height="614"></iframe >
		</div>
