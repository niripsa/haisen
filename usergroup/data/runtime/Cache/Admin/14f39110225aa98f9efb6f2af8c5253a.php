	...
	<div class="wrap">
		...
		<div class="home_info">
			<ul id="thinkcmf_notices">
				<li><img src="/usergroup/admin/themes/simplebootx/Public/assets/images/loading.gif"style="vertical-align: middle;" /><span style="display: inline-block; vertical-align: middle;">加载中...</span></li>
			</ul>
		</div-->
		...
		<div class="home_info" id="home_devteam">
			<ul>
				<li><em></em> <a href="http://www.thinkcmf.com" target="_blank">www.thinkcmf.com</a></li>
				<li><em><?php echo L('TEAM_MEMBERS');?></em> </li>
