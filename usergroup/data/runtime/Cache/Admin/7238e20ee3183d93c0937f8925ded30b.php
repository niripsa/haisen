		...
		<form class="js-ajax-form" action="" method="post">
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>					
					<td>
					<?php if($vo["zcount"] > 0): if($vo["nickname"] != ''): ?><a href='<?php echo U("Usergroup/index_own",array("uid"=>$vo["uid"]));?>'><?php echo ($vo["nickname"]); else: ?>未关注<?php endif; ?>(<font color="red"><?php echo ($vo["zcount"]); ?></font>)</a>
					<?php else: ?>
