...
class View{
	...
	*/ 
    ...
    {
        $basic_obj = new Basic();
        $this->__siteurl = $basic_obj->siteurl();
    }
	...
	function element_wallet($name, $vars = array(), $wallet_id){ 
        extract($vars);
        switch ( $wallet_id['wallet_id'] ) {
            case '1':
                    $name = 'ajax_user_money';
                break;
            case '2':
                    $name = 'ajax_user_money_2';
                break;
            case '3':
                    $name = 'ajax_user_money_3';
                break;
            case '4':
                    $name = 'ajax_user_money_4';
                break;
            case '5':
                    $name = 'ajax_user_money_5';
                break;
            case '6':
                    $name = 'ajax_user_money_6';
                break;
            case '7':
                    $name = 'ajax_user_money_7';
                break;
            case '8':
                    $name = 'ajax_user_money_8';
                break;
            default:
                # code...
                break;
