...
<div id="main" style="min-height:300px;margin-bottom:20px;">
    <ul class="dailicenter">
        <li>
        <a href="<?php echo ADMIN_URL . 'daili.php?act=mymoneydata&status=not_received'; ?>"><i></i>
            未收货分销订单
            <span><?php echo ! empty( $rt['not_received'] ) ? $rt['not_received'] : '0.00'; ?>元</span>
        </a>
        </li>
        <li>
        <a href="<?php echo ADMIN_URL . 'daili.php?act=mymoneydata&status=shouhuo'; ?>"><i></i>
            已收货分销订单
            <span><?php echo ! empty( $rt['pay3'] ) ? $rt['pay3'] : '0.00'; ?>元</span>
        </a>
        </li>
        <li>
        <a href="<?php echo ADMIN_URL.'daili.php?act=group_money_data&status=not_received_group'; ?>"><i></i>
            未收货团购订单
            <span><?php echo ! empty( $rt['not_received_group'] ) ? $rt['not_received_group'] : '0.00'; ?>元</span></a>
        </li>
        <li>
        <a href="<?php echo ADMIN_URL.'daili.php?act=group_money_data&status=received_group'; ?>"><i></i>
            已收货团购订单
            <span><?php echo ! empty( $rt['received_group'] ) ? $rt['received_group'] : '0.00'; ?>元</span></a>
        </li>

        <li>
            <a href="<?php echo ADMIN_URL.'daili.php?act=allmoney';?>"><i></i>所有佣金</a>
        </li>
    </ul>
</div>
