...
<div id="header" style="background:#4C3C22; line-height:46px; font-size:16px; text-align:center; border-bottom:none"> <?php echo NAVNAME; ?> </div>
    
<style type="text/css">
#main li:hover{ background:#ededed}
</style>
<form action="" method="GET">
<input type="hidden" name="act" value="my_is_daili" />
<div style="background:#F08125; line-height:44px; padding-left:10px; padding-right:10px;">
    <div style="width:80%; float:left;height:44px; text-align:right">
      <input type="text" name="nickname" placeholder="输入昵称" value="<?php echo $_GET['nickname']; ?>" style="background:#FFF; height:30px;border-radius:8px; border:1px solid #ededed; width:100%; margin-bottom:3px; line-height:normal; color:#999; text-indent:2em" />
    </div>
...
<div id="main" style="min-height:300px;margin-bottom:20px;">
    ...
    ?>
        <li style="padding:5px; border-bottom:1px solid #d8d8d8; position:relative">
            ...
            <img src="<?php echo $this->img('dui2.png'); ?>" style="position:absolute; bottom:5px; right:-2px; z-index:7" />
            <?php } ?>
            </div>
            <div style="float:right; width:78%;">
            <p style="line-height:23px"><?php echo $row['nickname'] ? : '未关注'; ?> &nbsp;&nbsp; </p>
            <p style="line-height:23px">
                资金&nbsp;<font color="#FF0000">￥<?php echo $row['money_ucount'] ? : 0; ?></font>&nbsp;
                |&nbsp;积分&nbsp;<font color="#FF0000"><?php echo $row['mypoints'] ? : 0; ?></font>
                &nbsp;|&nbsp;邀请&nbsp;<font color="#FF0000"><?php echo $row['zcount1'] > 0 ? $row['zcount1'] : 0; ?></font>
            </p>
            </div>
            <div class="clear"></div>
            </a>
