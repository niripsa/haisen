...
<div id="main" style="min-height:300px">
    ...
    <form name="USERINFO2" id="USERINFO2" action="" method="post">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="line-height:30px;">
           <tr>
              <td width="26%" align="right" style="padding-bottom:2px;"><b class="cr2">*</b> 开户地址：</td>
              <td width="74%" align="left" style="padding-bottom:2px;">
              <input type="text" value="<?php echo isset($rts['bankaddress']) ? $rts['bankaddress'] : '';?>" name="bankaddress" class="pw" placeholder="如：XX省XX市" />
              </td>
           </tr>
          <tr>
            <td width="26%" align="right" style="padding-bottom:2px;"><b class="cr2">*</b> 开户银行：</td>
            <td width="74%" align="left" style="padding-bottom:2px;">
            <input type="text" value="<?php echo isset($rts['bankname']) ? $rts['bankname'] : '';?>" name="bankname"  class="pw"  placeholder="正确填写开户行 如：XX银行XX分行XX支行"/></td>
          </tr>
          <tr>
