...
<div style="min-height:300px; padding-bottom:10px;" class="ucenter">
    <div class="meCenter">
        <ul class="meCenterBox">
          <li class="meCenterBoxWriting">
            <p>昵称:<?php echo empty($rt['userinfo']['nickname']) ? '未关注' : $rt['userinfo']['nickname'];?></p>
            <p style="line-height:22px;">
            <?php if ( ! $rt['userinfo']['subscribe_time'] ) { ?>
            ...
            <?php } ?>
            <br>
            分销商:&nbsp;&nbsp;<?php echo $rt['userinfo']['user_rank'] == '1' ? '否' : '是'; ?>
            </p>
          </li>
          ...
          <li>
              ...
              <img src="<?php echo SITE_URL.$ad['ad_img'];?>" width="100%" style="min-height:100px">
              <?php } else { ?>
              <p style="display:block; width:100%; min-height:120px;" class="jbjb"></p>
              <?php } ?>
          </li>
        </ul>
        </div>
    ...
    <div class="navbar">
    <ul>
        <li class="li1"><a href="javascript:;">资金:￥<?php echo empty($rt['userinfo']['mymoney']) ? '0.00' : $rt['userinfo']['mymoney'];?></a></li>
    ...
    <div data-role="content" class="ui-content" role="main">
        <div class="uitem">
            ...
            <ul class="gonglist gg1">
                ...
                <li class="uli10"><p><a href="javascript:;"><i></i>贡献佣金<span>￥<?php echo empty($rt['mymoney1']) ? '0.00' : $rt['mymoney1']; ?></span></a></p></li>
                <div class="clear"></div>
            </ul>
        </div>
        ...
        <div class="uitem">
            ...
            <ul class="gonglist gg2">
                ...
                <li class="uli9"><p><a href="javascript:;"><i></i>消费金额<span>￥0.00</span></a></p></li>
                <li class="uli10"><p><a href="javascript:;"><i></i>贡献佣金<span>￥<?php echo empty($rt['mymoney2']) ? '0.00' : $rt['mymoney2']; ?></span></a></p></li>       
                <div class="clear"></div>
            </ul>
        </div>
        ...
        <div class="uitem">
            ...
            <ul class="gonglist gg3">
                ...
                <li class="uli9"><p><a href="javascript:;"><i></i>消费金额<span>￥0.00</span></a></p></li>
                <li class="uli10"><p><a href="javascript:;"><i></i>贡献佣金<span>￥<?php echo empty($rt['mymoney3']) ? '0.00' : $rt['mymoney3']; ?></span></a></p></li>       
                <div class="clear"></div>
            </ul>
        </div>
  </div>
