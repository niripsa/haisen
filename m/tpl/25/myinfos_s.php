...
<div id="main" style=" min-height:300px">
	 <?php if(!empty($rt['userress'])){ 
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom:1px solid #d1d1d1;padding:10px; margin:0px; line-height:24px; background-color:#fafafa;">
			  ...
			  <tr>
			  <td>
			   <a onclick="ressinfoop('<?php echo $row['address_id'];?>','showupdate',this)">
			   	<img src="<?php echo SITE_URL.'theme/images/btu_up.gif';?>" height="26" width="66" border="0" style="cursor:pointer"/>
			   </a>&nbsp; 
			   	<!--onclick="ressinfoop('<?php echo $row['address_id'];?>','showupdate',this)"-->
