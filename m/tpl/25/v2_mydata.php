...
<div id="main" style="min-height:300px;margin-bottom:20px;">
    <ul class="dailicenter">
        ...
        <li>
        <a href="javascript:void(0)"><i></i>下单购买
            <span>
            <?php echo empty($rt['userinfo']['ordercount']) ? '0' : $rt['userinfo']['ordercount'];?>单
            </span>
        </a>
        </li>
        <li>
        <a href="<?php echo ADMIN_URL.'daili.php?act=my_is_daili';?>"><i></i>成为分销
            <span>
            <?php echo empty($rt['userinfo']['fxcount']) ? '0' : $rt['userinfo']['fxcount'];?>人
            </span>
        </a>
        </li>
        <?php 
            $my_qrcode_url = ADMIN_URL . 'user.php?act=myerweima';
        ?>
        <li style="border-bottom:none; font-weight:bold">        
            <a href="<?php echo $my_qrcode_url; ?>"><i></i>我的二维码</a>
        </li>
    </ul>
</div>
