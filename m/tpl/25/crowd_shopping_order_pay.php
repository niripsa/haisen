    ...
    <div class="goodslist">
        ...
        <tr>
            <td align="left" colspan="2">
                ...
                <?php 
                if($rt['orderinfo']['pay_id']==7) {echo "(你的佣金".$rt['userinfo']['user_money']."元)";}
                if($rt['orderinfo']['pay_id']==8) {echo "(你的优惠卷".$rt['userinfo']['pay_points']."分)";}
                ?>
                </p>
            </td>
        </tr>
        ...
        <?php if ( $rt['orderinfo']['pay_status'] != '1' ) { ?>
        <div>
            <a href="<?php echo ADMIN_URL.'crowd_mycart.php?type=fastpay2&oid='.$rt['orderinfo']['order_id'];?>" class="btn-buy button ui-btn ui-btn-text-only"><span class="ui-btn-text">立即支付</span></a>
        </div>
        <?php } ?>
    </div>
</div>
