...
<div id="main" style="padding-top:0px; min-height:300px">
    <div class="checkout">
    <form action="<?php echo ADMIN_URL;?>mycart.php?type=group_confirm" method="post" name="CONSIGNEE_ADDRESS" id="CONSIGNEE_ADDRESS">
        ...
        <?php $userress_id = 0; foreach ( $rt['userress'] as $row ) { ?>
          ...
          <td>
            ...
            <input class="showaddress" name="userress_id" type="radio" value="0" />&nbsp;添加新收货地址
            </label>
          </td>
          </tr>
          <tr>
            <td align="left">
                <table width="100%" border="0" cellpadding="0" cellspacing="0"<?php if ( ! empty( $rt['userress'] ) ) echo ' style="display:none"';?> class="userreddinfo">
                  <tr>
                    ...
                    <td align="left">
                    <input type="text" value="" name="consignee"  class="pw" style="width:95%;" /> 
                    </td>
                  </tr>
                   <tr>
                  ...
                  <tr class="address_sh">
                    ...
                    <td align="left">
                    <input type="text" value="" name="address"  class="pw" style="width:95%;"/>
                    </td>
                  </tr>
                  <tr>
                    <td align="right">电话：</td>
                    <td align="left">
                    <input type="text" value="" name="mobile"  class="pw" style="width:95%;"/>
                    </td>
                  </tr>
                  <tr>
                  <td>&nbsp;</td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width:100%;margin-top:5px;border-top:1px solid #ededed;">
            <tr>
                <td style="width:80px; text-align:center; height:80px; padding-top:10px; overflow:hidden; border-bottom:1px solid #ededed;" valign="top">
                    <img 
                        src="<?php echo SITE_URL.$goodslist['goods_img']; ?>" 
                        title="<?php echo $goodslist['group_name'];?>" border="0" 
                        style="width:78px; height:78px; border:1px solid #ededed; padding:1px; margin-left:5px;"
                    />
                </td>
                ...
                <p style="padding-left:10px; padding-right:36px; position:relative; line-height:18px;">
                    <?php echo $goodslist['group_name']; ?>
                </p>

                <div class="item" style="height:20px; line-height:20px; position:relative; padding-left:10px; padding-top:7px">
                    团购价:<font color="#ee3838">￥<?php echo $goodslist['price']; ?></font>
                </div>

                <div class="item" style="height:20px; line-height:20px; position:relative; padding-left:10px; padding-top:7px">
                    团购数量:<font color="#ee3838"> <?php echo $number; ?>件 </font>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width:100%; margin-top:10px; border-bottom:1px solid #ededed">
            <tr>
              ...
              <td align="left" width="78%">
                <?php if ( ! empty( $rt['paymentlist'] ) ) { ?>
                <table border="0" cellpadding="0" cellspacing="0" style="width:100%;"><tr>
                <?php foreach ( $rt['paymentlist'] as $k => $row ) { ?>
            ...
            <tr>
                ...
                <td align="left" width="78%">
                    ...
                    ?>
                       <td>
                       <label>
                       <span><input onclick="return jisuan_shopping('<?php echo $row['shipping_id'];?>')"<?php echo $k=='0' ? ' checked="checked"':'';?> name="shipping_id" id="shipping_id" value="<?php echo $row['shipping_id'];?>" type="radio" /></span>
                       <strong><?php echo $row['shipping_name'];?></strong>
                       </label>
                      <?php 
        ...
        <div style="padding-left:10px; padding-right:10px;">
            ...
            实付金额: ￥<span class="ztotals"><?php echo $goodslist['price'] * $number; ?></span>元
            </p>
