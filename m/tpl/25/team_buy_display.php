...
<div class="yScrollList">
    ...
    <div id="main" style="min-height:300px">
     <table  width="100%" border="0" cellpadding="0" cellspacing="0" style="line-height:25px;  overflow:hidden">
      ...
      <?php if ( ! empty( $rt['teampage'] ) ) { ?>
      <div class="pages">
        <?php echo $rt['teampage']['showmes']; ?>
        <?php echo $rt['teampage']['first'] . $rt['teampage']['previ']
              . $rt['teampage']['next'] . $rt['teampage']['Last']; 
        ?>
      </div>
      <?php } ?>
      </td>
