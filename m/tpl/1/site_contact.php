...
<div id="pop-share" style=" display:none;width:100%; height: 100%; position:absolute; top:0px; right: 0px; z-index:9999999; opacity: 0.9;background: url(<?php echo ADMIN_URL.'tpl/1/images/text.png';?>) 100% 0% / 100% no-repeat rgb(0, 0, 0);" onclick="$(this).hide();"></div>
