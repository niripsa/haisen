...
<div id="pop-share" style=" display:none;width:100%; height: 100%; position:absolute; top:0px; right: 0px; z-index:9999999; opacity: 0.5;background: url(<?php echo ADMIN_URL.'tpl/1/images/text.png';?>) right top no-repeat #000;" onclick="$(this).hide();"></div>
