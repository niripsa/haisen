<link type="text/css" rel="stylesheet" href="<?php echo ADMIN_URL;?>tpl/1/css.css?v=4" media="all" />
<style type="text/css">
...
<div id="main">
	...
	<?php/* $this->element('1/menu_top',array('lang'=>$lang));*/?>	
	...
	<div class="indexitem" style="padding-top:0px">
		...
		<?php if(!empty($rt['goods'][$row['cat_id']]))foreach($rt['goods'][$row['cat_id']] as $k=>$rows){?>
			<li style="width:100%; float:left; position:relative;font-size:14px">
				...
				<span style=" margin-right:10px;width:80px; height:32px; display:block; text-align:center; line-height:32px; font-size:14px; background:#f22f6b;border-radius:5px; position:absolute; bottom:13px; right:10px; z-index:10; color:#FFFFFF;" class="buyfals">立即购买</span>
				</a>
			</li>
		<?php } ?>
		<div class="clear"></div>
