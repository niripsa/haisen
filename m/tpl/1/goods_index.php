...
<div id="main">
	<div class="mainhead" style="padding:5px; border-top:1px solid #ededed;border-bottom:1px solid #ededed;background:#FFF">
		...
		<div class="shopinfol" style="font-size:1.3em;color:#949494;text-align:center;">
		<h1 style=""><?php echo $rt['goodsinfo']['goods_name'];?></h1>
		<!--<?php if(!empty($rt['goodsinfo']['sort_desc'])){?><p><?php echo $rt['goodsinfo']['sort_desc'];?></p><?php } ?>-->
        <p style="text-align:center"><span class="vippfont" style="color:#5F5757;">促销价:</span><span class="price">￥<?php echo str_replace('.00','',$rt['goodsinfo']['pifa_price']);?></span></p>
		<p style="font-size:16px;text-align:center">市场价:<font class="spirce"><del>￥<?php echo str_replace('.00','',$rt['goodsinfo']['shop_price']);?></del></font></p>
...
.top_menu li.li11{ background:#343434;padding-left:10%;}
.top_menu li.li11 a{ background:#fff;padding:0px;height:35px;float:left;margin-top:3px;}
.top_menu li.li11 a:hover{ background:#000; color:#fff}
</style>
<?php
$nums = 0;
...
<div class="top_bar" style="-webkit-transform:translate3d(0,0,0);background:rgba(230,230,230,0.9);">
   <nav>
    ...
    <ul id="top_menu" class="top_menu">
     <li class="li11" style="width:60%">
     <span style="color:#fff;width:auto;height:55px;float:left;font-size:1.2em;line-height:55px;margin-right:10px;">数量</span>
     <span style="float:left;background:#fff;height:42px;margin-top:6px;border-radius:5px 5px 5px 5px">
     <a href="javascript:void(0)" id = "gjia"><img width="40" src="<?php  echo $this->img('productjie.png');?>" /></a>
     <input type="type" style="float:left;width:35px;height:39px;line-height:39px;background:#343434;margin-top:2px;text-align:center;font-size:2.5em;color:#fff;" value='1'/>
      <a href="javascript:void(0)" id="gjie" style=""><img width="40" src="<?php echo $this->img('productjia.png');?>" /></a>
      </span>
    <div style="clear:both;"></div>
    </li>
   <li class="li55" style="width:30%;">
<input type="button" id="cart" class="addcar" value="立即购买" style="cursor:pointer;width:100%;height:100%;border-radius:0px;" onclick="return addToCart('<?php echo $rt['goodsinfo']['goods_id'];?>','jumpshopping')">
</li>
