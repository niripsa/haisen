		...
		<a style="display:block" href="<?php echo ADMIN_URL.'site.php?act=newinfo&id='.$row['article_id'];?>">
			<div class="liLeft">
				<div class="llogo" style="position:relative">
					...
					<img src="<?php echo ADMIN_URL.'tpl/24/images/newbu.png';?>" style="width:90%; float:right; margin-right:15px;" />
				</div>
			</div>
			<div class="liRight">
				...
				<p style="height:50px; line-height:50px; border-top:1px solid #ededed; margin-top:15px; background:url(<?php echo ADMIN_URL.'tpl/24/images/d.png';?>)  right center no-repeat; font-size:18px; font-weight:bold">
					查看全文
				</p>
				<img src="<?php echo ADMIN_URL.'tpl/24/images/newtop_b.png';?>" style="width:100%; position:absolute; bottom:-6px; left:0px; z-index:99" />
				</div>
			</div>
			<div class="clear"></div>
			</a>
