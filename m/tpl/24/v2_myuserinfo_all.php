...
<div style="min-height:300px; padding-bottom:10px;" class="ucenter">
	...
	<div class="navbar">
	<ul>
		<li class="li1"><a href="<?php echo ADMIN_URL.'daili.php?act=monrydeial_user&tid='.$rt['userinfo']['user_id'];?>">佣金:￥<?php echo empty($rt['userinfo']['mymoney']) ? '0.00' : $rt['userinfo']['mymoney'];?></a></li>
  	...
  	<div data-role="content" class="ui-content" role="main">
		<div class="uitem">
			...
			<ul class="gonglist gg1">
				...
				-->
				<li class="uli10"><p><a href="javascript:;"><i></i>佣金余额<span>￥<?php echo empty($rt['mymoney1']) ? '0.00' : $rt['mymoney1'];?></span></a></p></li>
				<div class="clear"></div>
			</ul>
		</div>
		...
		<div class="uitem">
			...
			<ul class="gonglist gg2">
				...
				<li class="uli9"><p><a href="javascript:;"><i></i>消费金额<span>￥0.00</span></a></p></li>
				-->
				<li class="uli10"><p><a href="javascript:;"><i></i>佣金余额<span>￥<?php echo empty($rt['mymoney2']) ? '0.00' : $rt['mymoney2'];?></span></a></p></li>		
				<div class="clear"></div>
			</ul>
		</div>
		...
		<div class="uitem">
			...
			<ul class="gonglist gg3">
				...
				<li class="uli9"><p><a href="javascript:;"><i></i>消费金额<span>￥0.00</span></a></p></li>
				-->
				<li class="uli10"><p><a href="javascript:;"><i></i><span>￥<?php echo empty($rt['mymoney3']) ? '0.00' : $rt['mymoney3'];?></span></a></p></li>		
				<div class="clear"></div>
			</ul>
		</div>
		</p>
