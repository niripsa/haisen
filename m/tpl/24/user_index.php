...
<div style="min-height:300px; padding-bottom:10px; font-size:14px; background:#FFF" class="ucenter">
	<div class="meCenter">
		<ul class="meCenterBox">
		  <li class="meCenterBoxWriting">
			...
			?>
			<br>
			东家:&nbsp;&nbsp;<?php echo $rt['userinfo']['user_rank']=='1' ? '否' : '是'; if($rt['userinfo']['user_rank']=='1'){?>(<a href="<?php echo ADMIN_URL.'in.php';?>"><font class="price">点击购买成为东家</font></a>)<?php } ?>
			</p>
		  </li>
	...
	<div class="navbar">
	<ul>
		<li><a href="<?php echo ADMIN_URL.'daili.php?act=myuserinfo&tid='.$rt['userinfo']['user_id'];?>">营业额:￥<?php echo empty($rt['userinfo']['zordermoney']) ? '0.00' : $rt['userinfo']['zordermoney'];?></a></li>
		<!--<li><a href="<?php echo ADMIN_URL;?>user.php?act=mypoints">积分:<?php echo empty($rt['userinfo']['mypoints']) ? '0' : $rt['userinfo']['mypoints'];?></a></li>-->
		<li><a href="<?php echo ADMIN_URL.'daili.php?act=monrydeial_all&tid='.$rt['userinfo']['user_id'];?>">佣金:￥<?php echo empty($rt['userinfo']['mymoney']) ? '0.00' : $rt['userinfo']['mymoney'];?></a></li>
	</ul>
	</div>
