...
<div id="main">
	<div class="mainhead" style="padding:5px; border-top:1px solid #ededed;border-bottom:1px solid #ededed;background:#FFF">
		...
		<p style="font-size:16px;">市场价:<font class="spirce"><del>￥<?php echo str_replace('.00','',$rt['goodsinfo']['shop_price']);?></del></font>&nbsp;&nbsp;<span class="vippfont">促销价:</span><span class="price">￥<?php echo str_replace('.00','',$rt['goodsinfo']['pifa_price']);?></span>
		&nbsp;&nbsp;<span class="vippfont">可返积分:</span><span class="price"><?php echo $scores;?></span>
		</p>
