<link type="text/css" rel="stylesheet" href="<?php echo ADMIN_URL;?>tpl/24/css.css?v=4" media="all" />
<style type="text/css">
...
<div id="main">
	...
	<?php 
	$this->element('24/menu_top',array('lang'=>$lang));
	...
	<div class="indexitem" style="padding-top:0px">
		...
		<?php if(!empty($rt['goods'][$row['cat_id']]))foreach($rt['goods'][$row['cat_id']] as $k=>$rows){?>
			<li style="width:50%; float:left; position:relative;font-size:14px">
				...
				<span style=" margin-right:1px;width:60px; height:20px; display:block; text-align:center; line-height:19px; font-size:14px; background:#3d8b1d;border-radius:5px; position:absolute; bottom:8px; right:8px; z-index:8; color:#FFFFFF;" class="buyfals">立即购买</span>
				</a>
			</li>
		<?php } ?>
		<div class="clear"></div>
