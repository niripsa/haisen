...
<!--			<li class="li3"><p><a href="<?php echo ADMIN_URL.'daili.php?act=v2_mymoney';?>"><i></i>我的佣金</a></p></li>
			...
			<li class="uli8"><p><a href="<?php echo ADMIN_URL.'user.php?act=zpoints';?>"><i>&nbsp;</i>积&nbsp;分&nbsp;榜</a></p></li>
			<li class="uli2"><p><a href="<?php echo ADMIN_URL.'user.php?act=myerweima';?>"><i></i>店铺二维码</a></p></li>
