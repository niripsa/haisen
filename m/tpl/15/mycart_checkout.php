...
<div style="height:30px; padding-top:10px; padding-left:10px; padding-right:10px; background:#F08125; border-bottom:1px solid #ccc; color:#fff">
...
<div id="main" style="padding-top:0px; min-height:300px">
	...
	<form action="<?php echo ADMIN_URL;?>mycart.php?type=confirm" method="post" name="CONSIGNEE_ADDRESS" id="CONSIGNEE_ADDRESS">
		...
		<div style="padding-left:10px; padding-right:10px;">
			<p style="padding-bottom:10px; padding-top:10px;"><a href="javascript:;" onclick="return ajax_clear()" style="cursor:pointer; background:url(<?php echo ADMIN_URL.'tpl/15/images/iconfont-delete.png';?>) left center no-repeat; padding-left:28px; height:30px; line-height:30px; display:block">清空购物车</a></p>
...
<!--			<p style="height:20px; line-height:20px;">
			...
			<input value="提交订单" type="submit" align="absmiddle" onclick="return checkvar()" style="width:100%; height:40px; line-height:40px; background:#FF7900; font-size:18px; color:#FFFFFF; font-weight:bold; text-align:center; cursor:pointer;"/>
			</p>
	  </div> 
	</form>
	</div>
