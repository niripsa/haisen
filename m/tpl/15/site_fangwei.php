<link href="<?php echo ADMIN_URL;?>tpl/15/css.css" rel="stylesheet" type="text/css" />
...
.shouquan .weixin div{ background:url(<?php echo ADMIN_URL;?>tpl/15/images/wx2.png) center center no-repeat; }
.shouquan .weixin div.active{background:url(<?php echo ADMIN_URL;?>tpl/15/images/wx.png) center center no-repeat #F4F4F4;}
.shouquan .wangwang div{ background:url(<?php echo ADMIN_URL;?>tpl/15/images/ww2.png) center center no-repeat;border-right:1px solid #ededed; border-left:1px solid #ededed}
.shouquan .wangwang div.active{background:url(<?php echo ADMIN_URL;?>tpl/15/images/ww.png) center center no-repeat #F4F4F4;}
.shouquan .shouji div{ background:url(<?php echo ADMIN_URL;?>tpl/15/images/sj2.png) center center no-repeat}
.shouquan .shouji div.active{background:url(<?php echo ADMIN_URL;?>tpl/15/images/sj.png) center center no-repeat #F4F4F4;}
...
<div class="page-bizinfo">
	...
	<div style="margin-bottom:20px; position:relative">
		<img src="<?php echo ADMIN_URL;?>tpl/15/images/fw1.jpg" style="width:100%" />
		<img src="<?php echo ADMIN_URL;?>tpl/15/images/fwss.jpg" style="width:120px;position:absolute; right:0px; bottom:20px; z-index:99; cursor:pointer" id="scanQRCode1" />
	</div>
	
	<div style="margin-bottom:20px; position:relative">
		<img src="<?php echo ADMIN_URL;?>tpl/15/images/fw2.jpg" style="width:100%" />
		<a href="tel:13764567708"><img src="<?php echo ADMIN_URL;?>tpl/15/images/fsbd.jpg" style="width:120px;position:absolute; right:0px; bottom:20px; z-index:99; cursor:pointer" /></a>
	</div>
	<div>
		<img src="<?php echo ADMIN_URL;?>tpl/15/images/fw3.jpg" style="width:100%" />
	</div>
</div>
