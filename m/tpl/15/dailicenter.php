...
.dailicenter li.li1 i{ background:url(<?php echo $this->img('15/images/3433.png');?>) 10% center no-repeat #f8f8f8;background-size:28px auto;}
...
.dailicenter li.li4 i{ background:url(<?php echo $this->img('15/images/23.png');?>) 10% center no-repeat #f8f8f8;background-size:28px auto;}
.dailicenter li.li5 i{ background:url(<?php echo $this->img('15/images/2323.png');?>) 10% center no-repeat #f8f8f8;background-size:28px auto;}
.dailicenter li.li6 i{ background:url(<?php echo $this->img('15/images/43434.png');?>) 10% center no-repeat #f8f8f8;background-size:28px auto;}
.dailicenter li.li7 i{ background:url(<?php echo $this->img('icon/dp.png');?>) 10% center no-repeat #f8f8f8;background-size:28px auto;}
.dailicenter li.li44 i{ background:url(<?php echo $this->img('15/images/23232.png');?>) 10% center no-repeat #f8f8f8;background-size:28px auto;}
.dailicenter li.li55 i{ background:url(<?php echo $this->img('15/images/212.png');?>) 10% center no-repeat #f8f8f8;background-size:28px auto;}
...
.dailicenter li.li1 a:hover i{ background:url(<?php echo $this->img('15/images/3433.png');?>) 10% center no-repeat #6EAAD3;background-size:28px auto;}
...
.dailicenter li.li4 a:hover i{ background:url(<?php echo $this->img('15/images/23.png');?>) 10% center no-repeat #6EAAD3;background-size:28px auto;}
.dailicenter li.li5 a:hover i{ background:url(<?php echo $this->img('15/images/2323.png');?>) 10% center no-repeat #6EAAD3;background-size:28px auto;}
.dailicenter li.li6 a:hover i{ background:url(<?php echo $this->img('15/images/43434.png');?>) 10% center no-repeat #6EAAD3;background-size:28px auto;}
...
.dailicenter li.li44 a:hover i{ background:url(<?php echo $this->img('15/images/23232.png');?>) 10% center no-repeat #6EAAD3;background-size:28px auto;}
.dailicenter li.li55 a:hover i{ background:url(<?php echo $this->img('15/images/212.png');?>) 10% center no-repeat #6EAAD3;background-size:28px auto;}
