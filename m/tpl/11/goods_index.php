...
<div style="height:34px; line-height:34px; padding-left:10px; padding-right:10px; background:#015a9e; font-size:16px; color:#FFF">基本信息</div>
...
.top_menu li.li4 a.butt-buy {display: inline-block;font-size: 15px;width: 100%;height: 40px;line-height: 38px;margin: 6px auto 5px auto;padding: 0;color: #FFF;border-radius: 3px;background:#015a9e;}
</style>
<?php
$nums = 0;
...
<div class="top_bar" style="-webkit-transform:translate3d(0,0,0);background:rgba(230,230,230,0.9);">
   <nav>
	...
	-->
	<li class="li4" style="width:100%;background:#015a9e;">
