...
<div id="main" style="min-height:300px;margin-bottom:20px;">
	<ul class="dailicenter">
		<li>
		<a href="<?php echo ADMIN_URL.'daili.php?act=mymoneydata&status=weifu';?>"><i></i>未付款订单<span><?php echo !empty($rt['pay1']) ? $rt['pay1'] : '0.00';?>元</span></a>
		</li>
		<li>
		<a href="<?php echo ADMIN_URL.'daili.php?act=mymoneydata&status=yifu';?>"><i></i>已付款订单<span><?php echo !empty($rt['pay2']) ? $rt['pay2'] : '0.00';?>元</span></a>
		</li>
		<li>
		<a href="<?php echo ADMIN_URL.'daili.php?act=mymoneydata&status=shouhuo';?>"><i></i>已收货订单<span><?php echo !empty($rt['pay3']) ? $rt['pay3'] : '0.00';?>元</span></a>
		</li>
		<li>
		<a href="<?php echo ADMIN_URL.'daili.php?act=mymoneydata&status=quxiao';?>"><i></i>已取消作废<span><?php echo !empty($rt['pay4']) ? $rt['pay4'] : '0.00';?>元</span></a>
		</li>
		<li>
		<a href="<?php echo ADMIN_URL.'daili.php?act=mymoneydata&status=tongguo';?>"><i></i>审核通过的<span><?php echo !empty($rt['pay5']) ? $rt['pay5'] : '0.00';?>元</span></a>
		</li>
		<li>
		<a href="<?php echo ADMIN_URL.'daili.php?act=postmoney';?>"><i></i>申请提款<span style="background:url(<?php echo $this->img('x.png');?>) left center no-repeat"></span></a>
		</li>
		<li style="border-bottom:none">
		<a href="<?php echo ADMIN_URL.'daili.php?act=postmoneydata';?>"><i></i>提款记录<span style="background:url(<?php echo $this->img('x.png');?>) left center no-repeat"></span></a>
		</li>
	</ul>
</div>
