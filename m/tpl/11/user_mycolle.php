...
<p>
<a href="javascript:void(0);" style="display:block; padding:3px 5px 3px 5px; float:left; background:#fafafa; border-bottom:2px solid #d5d5d5;border-right:2px solid #d5d5d5;border-radius:14px; margin-right:5px;" onclick="return addToCart('<?php echo $row['goods_id'];?>')">加入购物车</a>
<a href="javascript:void(0);" style="display:block; padding:3px 5px 3px 5px; float:left; background:#fafafa; border-bottom:2px solid #d5d5d5;border-right:2px solid #d5d5d5;border-radius:14px; margin-right:5px;" onclick="delmycoll('<?php echo $row['rec_id'];?>',this)">删除</a>
</p>
</td>
</tr>
<?php } } ?>
