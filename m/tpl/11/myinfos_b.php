...
<div id="main" style="min-height:300px">
	...
	<form name="USERINFO2" id="USERINFO2" action="" method="post">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="line-height:30px;">
		   <tr>
			<td width="26%" align="right" style="padding-bottom:2px;"><b class="cr2">*</b> 帐号类型：</td>
			<td width="74%" align="left" style="padding-bottom:2px;">
			<input type="text" value="<?php echo isset($rts['bankname']) ? $rts['bankname'] : '';?>" name="bankname"  class="pw"  placeholder ="填写银行名称/支付宝/微信"/></td>
		  </tr>
          <tr>
			<td width="26%" align="right" style="padding-bottom:2px;"><b class="cr2">*</b> 帐号：</td>
			<td width="74%" align="left" style="padding-bottom:2px;">
			<input type="text" value="<?php echo isset($rts['banksn']) ? $rts['banksn'] : '';?>" name="banksn"  class="pw"
            placeholder ="银行卡号/支付宝帐号/微信号"/></td>
		  </tr>
		   <tr>
			<td width="26%" align="right" style="padding-bottom:2px;"><b class="cr2">*</b> 真实姓名：</td>
			<td width="74%" align="left" style="padding-bottom:2px;">
			<input type="text" value="<?php echo isset($rts['uname']) ? $rts['uname'] : '';?>" name="uname"  class="pw"/></td>
		  </tr>
		   
		   <tr>
			<td width="26%" align="right" style="padding-bottom:2px;"><b class="cr2">*</b> 手机号码：</td>
			<td width="74%" align="left" style="padding-bottom:2px;">
