...
$rt = $app->action( 'shopping', 'get_openid_AND_group_pay_info' );

/* 异步通知地址 */
$notify_url   = ADMIN_URL . 'group_notify_url.php';
            ...
            WeixinJSBridge.invoke(
                ...
                function(res){
                    ...
                    if(str!=""){
                        rr = str.split(":");
                        if(rr[1]=='ok'){
                        window.location.href="<?php echo str_replace('/WxPay','',ADMIN_URL).'user.php?act=orderlist&group=1'; ?>";
                        }
                    }
                }
            );
