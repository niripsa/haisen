...
$rt = $app->action('crowd_shopping','get_openid_AND_pay_info');
// print_r( $rt );die;
/* 异步通知地址 */
$notify_url   = ADMIN_URL.'crowd_notify_url.php';
            ...
            WeixinJSBridge.invoke(
                ...
                function(res){
                    ...
                    if(str!=""){
                        rr = str.split(":");
                        if(rr[1]=='ok'){
                        window.location.href="<?php echo str_replace('/WxPay','',ADMIN_URL).'user.php?act=crowd_orderlist';?>";
                        }
                    }
                }
            );
